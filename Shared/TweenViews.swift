...
struct ExpandedView: View {
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            TweenMapSnapshotView(received: received?.coordinate, cachedCoordinate: cachedCoordinate, verticalFocusOffset: 0.28)
                .ignoresSafeArea()
...
private struct TweenMapSnapshotView: View {
    ...
    private func snapshotRegion() -> MKCoordinateRegion {
        let coordinates = [received, cachedCoordinate].compactMap { $0 }
